          ...
          {favori.map((item) => (
            <ul className="products" key={item.id}>
              ...
              <li className='name'>Name: {item.title}</li>
                ...
                <li className='description'>Description: {item.description.slice(0,55)}</li>
        ...
        <div className="product_card">
          {product.map((x) => (
            <ul className="products" key={x.id}>
                <div className="icon"><i onClick={()=>addFavori(x)} className="fa-solid fa-heart"></i></div>
              <img className='image' src={x.image} alt="" />
              <li className='name'>Name: {x.title}</li>
                <li className='price'>Price: {x.price}$</li>
                <li className='description'>Description: {x.description.slice(0,55)}</li>
